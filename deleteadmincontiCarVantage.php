...
<head>
  ...
  <title>adminVantageCar</title>
</head>
<body>

<h2>Delete Vantage Car Data</h2>
...
?>
       ...
       <td><a style="color: black" onclick="return confirmdelete()" href="delete_dataadmincontiCarVantage.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
       </tr>
<?php
$i++;
}
