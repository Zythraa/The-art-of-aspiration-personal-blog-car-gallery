...
<title>Update BMW Car Data</title>
...
$sql = "SELECT * FROM tbladminconticarbmw WHERE id='" . $_GET["id"] . "'";
...
$sql = "UPDATE tbladminconticarbmw SET comments='$Comments' WHERE id='" . $_GET["id"] . "'";
$result = mysqli_query ($conn, $sql);

if ($result) 
{
   echo "<script>alert('Record has Sucessfully Updated!'); document.location = 'updateadmincontiCarBMW.php?id=".$row['id'].";'</script>";
}
...
<form action="#" method="POST" enctype="multipart/form-data">
    <div class="section">BMW Details</div>
...
<a href="updateadmincontiCarBMW.php" class="back" style="position: relative; left: 500px; bottom: 19px; font-size: 18px; font-weight: bold; color: #634d65;">Back</a>
